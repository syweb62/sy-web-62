...
INSERT INTO public.social_media_links (platform_name, url, icon_name, display_order, is_active) 
SELECT * FROM (VALUES
    ('Instagram', 'https://instagram.com/sushiyaki', 'instagram', 1, true),
    ('Facebook', 'https://facebook.com/sushiyaki', 'facebook', 2, true),
    ('Twitter', 'https://twitter.com/sushiyaki', 'twitter', 3, true),
    ('WhatsApp', 'https://wa.me/1234567890', 'message-circle', 4, true),
    ('Phone', 'tel:+1234567890', 'phone', 5, true)
) AS v(platform_name, url, icon_name, display_order, is_active)
